                ...
                ColumnLayout {
                    ...
                    SettingsSection {
                        ...
                        ColumnLayout {
                            ...
                            HelpText { text: "<b>Optional panels</b> · enable the Function Row (F1–F12), the extra Function Row (F13–F24), Navigation keys, or Numpad in <b>Settings → Appearance → Panels</b>. A number row is always on screen, so there is nothing to turn on for digits." }
                            HelpText { text: "<b>Programmable function keys</b> · right-click any function key, or tap <b>Edit</b> at the end of the row and left-click one, to give it a shortcut (Ctrl+Shift+S in one click), a stored phrase, or just a clearer keycap label. F13–F24 are the ones worth reassigning: nothing binds them by default, so a game or OBS can take one without colliding with anything." }
