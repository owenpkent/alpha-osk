                ...
                ColumnLayout {
                    ...
                    SettingsSection {
                        ...
                        ColumnLayout {
                            ...
                            HelpText { text: "<b>Optional panels</b> · enable the Function Row (F1–F12), Navigation keys, or Numpad in <b>Settings → Appearance → Panels</b>. A number row is always on screen, so there is nothing to turn on for digits." }
