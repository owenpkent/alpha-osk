                ...
                ColumnLayout {
                    ...
                    SettingsSection {
                        ...
                        ColumnLayout {
                            ...
                            HelpText { text: "<b>Programmable function keys</b> · open <b>Settings → Function Keys</b> and tap any of the twenty-four to give it a shortcut (Ctrl+Shift+S in one click), a stored phrase, or just a clearer keycap label. That page also shows what every key is currently set to. F13–F24 are the ones worth reassigning: nothing binds them by default, so a game or OBS can take one without colliding with anything." }
