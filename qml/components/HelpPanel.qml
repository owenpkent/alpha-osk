                ...
                ColumnLayout {
                    ...
                    SettingsSection {
                        ...
                        ColumnLayout {
                            ...
                            HelpText { text: "<b>Optional panels</b> · enable Navigation keys or the Numpad in <b>Settings → Appearance → Panels</b>, and the two function rows in <b>Settings → Function Keys</b>. A number row is always on screen, so there is nothing to turn on for digits." }
                            HelpText { text: "<b>Programmable function keys</b> · open <b>Settings → Function Keys</b> and tap any of the twenty-four, or right-click one on the keyboard, to give it a shortcut (Ctrl+Shift+S in one click), a stored phrase, or just a clearer keycap label. That page also shows what every key is currently set to. F13–F24 are the ones worth reassigning: nothing binds them by default, so a game or OBS can take one without colliding with anything." }
                            HelpText { text: "<b>Compact View</b> · a denser 13×4 grid for small screens, in the same Panels section. Symbols move behind a <b>?123</b> key; a digit row, arrows, Enter, Home/End and Page Up/Down all stay visible. It turns the Navigation and Numpad panels off, since giving that width back to your screen is the point." }
