...
[![Tests](https://img.shields.io/badge/tests-1420-brightgreen.svg)](tests/)
...
- 1420 tests covering prediction, platform abstraction, bridge, vocab packs, telemetry, data export,
...
python -m pytest                            # Run the test suite (1420 tests)
